...
def list_tenders(
    ...
    try:
        ...
        raise HTTPException(502, f"Lecture tenders impossible: {e}")
...
def list_projects(
    ...
    try:
        ...
        raise HTTPException(502, f"Lecture projects impossible: {e}")
...
def list_organisations(
    ...
    try:
        ...
        raise HTTPException(502, f"Lecture organisations impossible: {e}")
...
def list_companies(
    ...
    try:
        ...
        raise HTTPException(502, f"Lecture companies impossible: {e}")
...
def tender_parties(tender_id: int):
    ...
    try:
        ...
        raise HTTPException(502, f"Lecture party_roles impossible: {e}")
...
def sources_health():
    ...
    try:
        ...
        raise HTTPException(502, f"Lecture ingest_runs impossible: {e}")
